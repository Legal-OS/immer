!(function(n, t) {
	...
	function i(n, t, r) {
		void 0 === r && (r = !1),
			0 === u(n)
				? (r ? Object.keys : Q)(n).forEach(function(e) {
	...
	function p(n) {
		...
		var t = T(n)
		delete t[H]
		for (var r = Q(t), e = 0; e < r.length; e++) {
			var i = r[e],
				u = t[i]
	...
	function h(n, t) {
		y(n) ||
			r(n) ||
			!e(n) ||
			(u(n) > 1 && (n.set = n.add = n.clear = n.delete = d),
			Object.freeze(n),
			t &&
				i(
					n,
	...
	function A(n, t, i, u, f, c) {
		if (r(f)) {
			var v = g(n, f, c && t && 3 !== t.t && !o(t.D, u) ? c.concat(u) : void 0)
			if ((a(i, u, v), !r(v))) return
			n._ = !1
		}
		if (e(f) && !y(f)) {
			if (!n.h.K && n.m < 1) return
			g(n, f), (t && t.A.p) || x(n, f)
		}
	}
	function x(n, t, r) {
		void 0 === r && (r = !1), n.h.K && n._ && h(t, r)
	}
	function z(n, t) {
		var r = n[H]
		return (r ? l(r) : n)[t]
	...
	function k() {
		...
		function e(n) {
			for (var t = n.u, r = n.k, e = Q(r), i = e.length - 1; i >= 0; i--) {
				var u = e[i]
				if (u !== H) {
					var f = t[u]
			...
			var s = !!t[H]
			return e.length !== Q(t).length + (s ? 0 : 1)
		}
		function u(n) {
			var t = n.k
		...
		b("ES5", {
			$: function(t, r) {
				var e = Array.isArray(t),
					i = (function(t, r) {
						var e = T(r)
						t && delete e.length, delete e[H]
						for (var i = Q(e), u = 0; u < i.length; u++) {
							var o = i[u]
							e[o] = n(o, t || !!e[o].enumerable)
						}
						if (t) {
									...
									if (r) {
										...
										if (4 === c)
											i(f, function(t) {
												...
												i(e, function(n) {
													void 0 !== f[n] || o(f, n) || ((a[n] = !1), E(r))
												})
										else if (5 === c) {
											if (
												(u(r) && (E(r), (a.length = !0)), f.length < e.length)
											)
		...
		return (
			...
			(function n(t) {
				...
				var r,
					...
					c = u(t)
				if (o) {
					if (!o.P && (o.t < 4 || !_("ES5").I(o))) return o.u
					;(o.R = !0), (r = K(t, c)), (o.R = !1)
				} else r = K(t, c)
				return (
					i(r, function(t, e) {
									...
									r.push(
										...
										u.push(
											p === a
												? {op: "remove", path: h}
												: "remove" === p
												? {op: a, path: h, value: e(s)}
												: {op: "replace", path: h, value: e(s)}
										)
								}
							})
						})(n, t, r, u)
					...
					case 1:
						return (function(n, t, r, i) {
							...
							for (var s = 0; s < u.length; s++)
								if (o[s] && f[s] !== u[s]) {
									var l = t.concat([s])
									r.push({op: "replace", path: l, value: e(f[s])}),
										i.push({op: "replace", path: l, value: e(u[s])})
								}
							for (var p = u.length; p < f.length; p++) {
								var h = t.concat([p])
								r.push({op: a, path: h, value: e(f[p])})
							}
							u.length < f.length &&
								i.push({
									op: "replace",
		...
		var o = function(n, t) {
					...
					(i.set = function(n, t) {
						...
						return (
							...
							(l(e).has(n) && l(e).get(n) === t) ||
								(r(e), E(e), e.D.set(n, !0), e.i.set(n, t), e.D.set(n, !0)),
							this
						)
					}),
					(i.delete = function(n) {
						...
						var t = this[H]
						return u(t), r(t), E(t), t.D.set(n, !1), t.i.delete(n), !0
					}),
					(i.clear = function() {
						var n = this[H]
						return u(n), r(n), E(n), (n.D = new Map()), n.i.clear()
					}),
					(i.forEach = function(n, t) {
						var r = this
						l(this[H]).forEach(function(e, i) {
			...
			a = (function() {
				...
				return (
					...
					(r.add = function(n) {
						var t = this[H]
						return u(t), this.has(n) || (i(t), E(t), t.i.add(n)), this
					}),
					(r.delete = function(n) {
						if (!this.has(n)) return !1
						var t = this[H]
	...
	var I,
		...
		B = N ? Symbol("immer-nothing") : (((I = {})["immer-nothing"] = !0), I),
		G = N ? Symbol("immer-draftable") : "__$immer_draftable",
		H = N ? Symbol("immer-state") : "__$immer_state",
		...
		V = {
			...
			set: function(n, t, r) {
				if (((n.D[t] = !0), !n.P)) {
					if (c(r, z(l(n), t)) && void 0 !== r) return !0
					R(n), E(n)
				}
				return (n.i[t] = r), !0
			},
	...
	i(V, function(n, t) {
		...
		(Y.deleteProperty = function(n, t) {
			return V.deleteProperty.call(this, n[0], t)
		}),
		(Y.set = function(n, t, r) {
			return V.set.call(this, n[0], t, r, n[0])
		})
	var Z = (function() {
			function n(n) {
				;(this.S = q),
			...
			return (
				(i.produce = function(n, r, i) {
					...
					if (!n || "object" != typeof n) {
						if ((f = r(n)) === B) return
						return void 0 === f && (f = n), this.K && h(f, !0), f
					}
					t(21, n)
				}),
	...
	var tn = nn.produce,
		...
		un = nn.setUseProxies.bind(nn),
		on = nn.applyPatches.bind(nn),
		fn = nn.createDraft.bind(nn),
		an = nn.finishDraft.bind(nn)
	;(n.Immer = Z),
		(n.applyPatches = on),
		...
		(n.original = function(n) {
			return r(n) || t(23, n), n[H].u
		}),
		(n.produce = tn),
		(n.produceWithPatches = rn),
		(n.setAutoFreeze = en),
		(n.setUseProxies = un),
