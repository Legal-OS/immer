...
declare type Tail<T extends any[]> = ((...t: T) => any) extends (
	_: any,
	...tail: infer TT
) => any
	? TT
...
export declare type Draft<T> = T extends AtomicObject
	? T
...
export declare type Immutable<T> = T extends AtomicObject
	? T
	: T extends ReadonlyMap<infer K, infer V>
